                        ...
                        <div id="login-box" class="login-box visible widget-box no-border">
                            <div class="widget-body">
                                <div class="widget-main">
                                    ...
                                    <form name="login"  action="<?php echo U('Login/dologin');?>"  method="POST" autocomplete="off"  data-validator-option="{theme:'yellow_right_effect',stopOnError:true}">
                                        <fieldset>
                                            <label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="text" name="email" class="form-control" placeholder="请输入邮箱" data-rule="邮箱:required;email" />
															<i class="icon-user"></i>
														</span>
                                            </label>
                                            ...
                                            <label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="password" name="password" class="form-control" placeholder="请输入密码" data-rule="密码:required;password;length[4~]"/>
															<i class="icon-lock"></i>
														</span>
                                            </label>
                                            ...
                                            <label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="text"  name="verify" class="form-control" placeholder="请输入验证码" data-rule="验证码:required;verify" />
															<i class="icon-lock"></i>
														</span>
                                            </label>
                                            <label class="block clearfix">
														<span class="block input-icon input-icon-right">
														    <img  class="img_change" src="<?php echo U('Login/verify');?>" alt="" width="200" height="60"/>
														</span>
                                            </label>
                                            <div class="space"></div>
